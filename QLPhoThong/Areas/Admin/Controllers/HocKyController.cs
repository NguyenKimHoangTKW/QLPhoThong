...
namespace QLPhoThong.Areas.Admin.Controllers
{
    public class HocKyController : Controller
    {
        ...
        {
            var Hocky = db.HOCKies.OrderBy(g => g.MaHky);
            ...
            int checkTotal = (int)(Hocky.ToList().Count / pageSize) + 1;
            // Nếu trang vượt qua tổng số trang thì thiết lập là 1 hoặc tổng số trang
            if (pageNumber > checkTotal) pageNumber = checkTotal;

            // 4. Trả kết quả về Views
            return View(Hocky.ToPagedList(pageNumber, pageSize));
        ...
        // GET: Admin/HocKy/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/HocKy/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "MaHky,TenHky,NamHoc")] HOCKY hOCKY)
        {
        ...
        // POST: Admin/HocKy/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHky,TenHky,NamHoc")] HOCKY hOCKY)
        {
            if (ModelState.IsValid)
            {
